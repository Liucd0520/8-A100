...
# python -m vllm.entrypoints.openai.api_server --served-model-name Qwen1.5-7B-Chat       --model /data/liucd/langchain/Qwen/Qwen1___5-7B-Chat  --port 1122      --enable-lora  --max-lora-rank 64       --lora-modules weather-lora=/data/liucd/Lora/对话_Qwen1.5/peft_qwen1.5/qwen_output_weather  huanhuan-lora=/data/liucd/Lora/对话_Qwen1.5/peft_qwen1.5/qwen_output_huanhuan

output_dir = 'qwen_output_huanhuan'
model_name_or_path = '/data/liucd/langchain/Qwen/Qwen1___5-32B-Chat-AWQ'
